...
function OnGUI (){
	if(selected){
		...
		//GUI.Label (Rect(Screen.width - 140,Screen.height-397,200,80),"Ammo : ",style1);
		GUI.Label (Rect(Screen.width - 85,Screen.height-455,200,80),"" + bulletsLeft, style2);
		GUI.Label (Rect(Screen.width - 70,Screen.height-455,200,80)," / " + magazines,style1);
		
		//GUI.Label(new Rect(SW * 0.92f, SH * 0.49f,SH * 0.200f, SH * 0.200f), ""+ bulletsLeft , style1);
		//GUI.Label(new Rect(SW * 0.94f, SH * 0.49f,SH * 0.200f, SH * 0.200f), " / " + magazines, style2);
		
		
		
		//GUI.Label(new Rect(SH * 2.05f, SH * 0.45f,SH * 0.200f, SH * 0.200f), ""+ bulletsLeft, style1);	
		//GUI.Label(new Rect(SH * 2.10f, SH * 0.45f,SH * 0.200f, SH * 0.200f), " / " + magazines, style2);	
					
							
		
		if(crosshair != null && inScope){	
			var w = crosshair.width/2;
			var h = crosshair.height/2;
			var position = Rect((Screen.width - w)/2,(Screen.height - h )/2, w, h);
			if (!aiming) { 
