...
function OnGUI (){
	if(selected){
		...
		if(selected){
			...
			GUI.Label (Rect(Screen.width - 85,Screen.height-640,200,80),"" + bulletsLeft, style1);
			GUI.Label (Rect(Screen.width - 70,Screen.height-640,200,80)," / " + magazines, style2);
			
			//for health score
		//GUI.Label(new Rect(SH * 2.05f, SH * 0.13f,SH * 0.200f, SH * 0.200f), ""+ bulletsLeft , style1);
		//GUI.Label(new Rect(SH * 2.10f, SH * 0.13f,SH * 0.200f, SH * 0.200f), " / " + magazines, style2);
